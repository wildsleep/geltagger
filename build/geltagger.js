...
*/
(function() {
  var argv, async, changeExt, deleteSource, exec, fs, gelbooruLookup, generateIPTCText, getData, imagemagickConvertPath, inputDirectory, interval, md5, mixin, outputDirectory, path, ratings, reject, restler, sys, tagDirectory, tagFile, timers, trim, watch, watchDirectory, writeTags, xml2js;
  ...
  changeExt = function(filename, ext) {
    var oldExt;
    oldExt = path.extname(filename);
    if (oldExt === "") return filename + ext;
