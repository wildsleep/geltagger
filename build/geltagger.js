...
*/
(function() {
  var argv, async, exec, fs, gelbooruLookup, generateIPTCText, getData, imagemagickConvertPath, inputDirectory, interval, md5, mixin, outputDirectory, path, ratings, reject, restler, sys, tagDirectory, tagFile, timers, trim, watch, watchDirectory, writeTags, xml2js;
